...
$query_right = "SELECT movie.mprice, playlist.pmname, playlist.ptime FROM movie, playlist WHERE playlist.spid='1' AND playlist.pmname = movie.mname";
...
//				$("#buy").click(function(){
//					
//						$.post("seatinsert.php",{"dname":dname,"dtime":dtime,"dseat":ararry,"dprice":dprice,"name":userid,"ddate":ddate},function(data){console.log(data)
//																													alert(data)
//																																   });      
//					
//					
//				})	
//					$("#close").click(function(){alert("取消成功!欢迎下次购买！")window.location.href="index.php";}
//				console.log(userid,dname,ddate,dtime,ararry)	
