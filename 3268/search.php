...
$query_m1 = "SELECT movie.mname, movie.spicture, movie.mprice FROM movie where mname = '".$_GET['nametext']."'";
//$query_m1 = "SELECT movie.mname, movie.spicture, movie.mprice FROM movie where mname = '奇门遁甲'";
...
<?php			  
	if(mysql_fetch_assoc($m1)==""){echo "<h1 align='center'>未查找到相关电影！</h1>";}
	else {
			 while($row_m1 = mysql_fetch_assoc($m1)) {
