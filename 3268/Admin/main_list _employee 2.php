    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <?php do { ?>
        <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          ...
          <td align="center" valign="middle" class="borderbottom"><a href="main_list_employee2.php?eid=<?php echo $row_Recordset1['eid'];?>" target="mainFrame"  class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="main_list _employee2.php"?seid=<?php echo $row_Recordset1['eid']; ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
        </tr>
...
$sql = "delete form 'employee' where eid = '".$_GET['eid']."'";
	mysql_query($sql);
	alert("删除成功！");
}
