    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <?php do { ?>
        <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
          <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['eid']; ?></td>
          <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['ename']; ?></td>
          <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['esex']; ?></td>
          <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['ephone']; ?></td>
		  <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['eaddress']; ?></td>
          <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['ezhiwei']; ?></td>
          
          <td align="center" valign="middle" class="borderbottom"><a href="bianji.php?id=<?php echo $row_Recordset1['eid'];?>" target="mainFrame"  class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="sc.php?id=<?php echo $row_Recordset1['eid']; ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
        </tr>
