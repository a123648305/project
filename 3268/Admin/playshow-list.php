...
<style>
	#addbox{position:absolute;left: 0;top: 0;bottom: 0;right: 0;margin: auto;border:1px solid;width: 500px;height: 400px;background-color: whitesmoke;padding: 10px 10px}	
</style>
</head>
<body>
<!--main_top-->
...
$(function () {
        $("#del").click(function () {//alert("2");
			...
			$.post("delete.php",{ids},function(data){console.log(data);alert(data)});						 
