...
$query_minformation = "SELECT * FROM movie where mid=1";
$minformation = mysql_query($query_minformation, $test) or die(mysql_error());
...
观看时间
      <input name="tt" type="radio"  value=" <?php echo $row_stime['pdata']; ?> ">
      <?php echo $row_stime['pdata']; ?> </label>
  
      <input type="radio" name="tt"  value="12月17日 ">
  2017年12月16日</label></div><hr>
