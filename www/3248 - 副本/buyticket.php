...
<!-- //影片大图 -->
			...
			<div name="showpost" style="padding-top:20px; font-size:16px" ><table width="100%" border="0" cellspacing="10" cellpadding="0" id="main-tab1" ><h2 style="font-size:26px; color:#333"><b><center>烟花</center></b></h2>
			<tr><td width="13%"><span>
			  <h1><strong><center>时长：91分钟</center></strong></h1></span></td><td width="14%"><span>
			  <h1>导演：新房昭之</h1>
			  </span></td><td width="18%"><span>
			  <h1><strong>类型：爱情/穿越</strong></h1></span></td><td width="55%"><span>
			  <h1><strong>主演：广濑铃,菅田将晖,松隆子</strong></h1>
			  </span></td></tr> </table>

<!-- //购票选择 -->			
<!-- //选择时间 -->  
<form name="gt" method="post" action="seat.php?m=花火" >
<div  style="padding-left:100px; font-size:18px; ">
观看时间
      <input name="tt" type="radio"  value="12月19日  ">
      2017年12月19日 </label>
  
      <input type="radio" name="tt"  value="12月20日 ">
  2017年12月20日</label>
...
<div>
    ...
    <table width="86%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#FCFCFC'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">日语</td>
