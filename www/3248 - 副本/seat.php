...
$query_Recordset1 = "SELECT dtable.dseat FROM dtable";
...
?>
    ...
    <body><form action="ok.php" method="post">
        <div class="container">
          <h2 class="title">在线选座<img src="images/lc.png" width="950" /></h2>
            ...
            <div class="demo clearfix">
                ...
                <div class="booking_area">
                    <p>电影：<span><?php echo $_GET[m]; ?></span></p>
                    <p>时间：<span><?php echo $_POST['tt'].$_SESSION['t1'];?></span></p>
                    <p>座位：</p>
                    <ul id="seats_chose"></ul>
                    <p>票数：<span id="tickects_num">0</span></p>
                    <p>总价：<b>￥<span id="total_price">0</span></b></p>
                    <input name="提交" type="submit" class="btn" onclick="&lt;script language=&quot;javascript&quot;&gt;
alert(&quot;购买成功！&quot;);&lt;/script&gt;" value="确定购买"  />
                    <div id="legend"></div>
                </div>
            </div>
        </div></form>
