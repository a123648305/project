...
$query_Recordset1 = "SELECT `user`.userid, `user`.username, `user`.userpad, `user`.userphone, vip.vid, vip.vname, vip.vcount FROM `user`, vip WHERE `user`.other =vip.vid";
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <?php do { ?>
        <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
		  ...
		  <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['vid']; ?></td>
          <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['vname']; ?></td>
          <td align="center" valign="middle" class="borderright borderbottom"><?php echo $row_Recordset1['vcount']; ?></td>
          <td align="center" valign="middle" class="borderbottom"><a href="bianji.php?id=<?php echo $row_Recordset1['userid'];?>&vid=<?php echo $row_Recordset1['vid'];?>" target="mainFrame"  class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="sc.php?id=<?php echo $row_Recordset1['userid']; ?>&vid=<?php echo $row_Recordset1['vid'];?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
        </tr>
