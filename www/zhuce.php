...
//$sql = "INSERT INTO 'user' ('userid', 'username', 'userpad', 'userphone','other')
//VALUES ('".$userid."', '".$username."', '".$userpad."','".$userphone."','NULL')";

$sql = "INSERT INTO `user` (`userid`, `username`, `userpad`, `userphone`, `other`) VALUES ('".$userid."', '".$username."', '".$userpad."', '".$userphone."', 1)";
$rs=mysql_query($sql);
echo "<script>alert('注册成功，欢迎你的使用！');location.href='login.php';</script>";
mysql_close($connect);
?> 
