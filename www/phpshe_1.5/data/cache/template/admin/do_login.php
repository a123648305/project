...
<style type="text/css">
body{background:#3C7DBE url(<?php echo $pe['host_tpl'] ?>images/login_bg1.jpg) no-repeat center top; font-family:'Microsoft Yahei','Simsun',"宋体"}
...
<div class="login">	
	...
	<div class="login_btn"><input type="submit" name="pesubmit" value="登 录" /></div>
</div>
</form>
</body>
