...
<div class="right">
	<div class="now">
		<a href="admin.php?mod=user" <?php if($mod=='user'):?>class="sel"<?php endif;?>>会员列表（<?php echo $tongji['user'] ?>）</a>
		<a href="admin.php?mod=userbank" <?php if($mod=='userbank'):?>class="sel"<?php endif;?>>收款账户（<?php echo $tongji['userbank'] ?>）</a>
		<a href="admin.php?mod=useraddr" <?php if($mod=='useraddr'):?>class="sel"<?php endif;?>>收货地址（<?php echo $tongji['userbank'] ?>）</a>
		<div class="clear"></div>
	</div>
	<div class="right_main">
		...
		<tr>
			...
			<td class="num"><span <?php if(pe_date($v['user_ltime'], 'Y-m-d') == date('Y-m-d')):?>class="cred"<?php endif;?>><?php echo pe_dayago($v['user_ltime']) ?></span></td>
			<td>
