...
<div class="right">
	<div class="now">
		<a href="admin.php?mod=pointlog" class="sel"><?php echo $menutitle ?>（<?php echo $tongji['all'] ?>）</a>
		<div class="clear"></div>
	</div>
	<div class="right_main">
		...
		<tr>
			<th class="bgtt" width="140">交易日期</th>
			<th class="bgtt" width="150">用户名</th>
			<th class="bgtt" width="100">交易类型</th>
			<th class="bgtt" width="100">增加(点)</th>
			<th class="bgtt" width="100">支出(点)</th>
			<th class="bgtt" width="100">结余(点)</th>
			<th class="bgtt">备注</th>
		</tr>
		<?php foreach($info_list as $v):?>
		<tr>
			<td class="num"><span <?php if(pe_date($v['pointlog_atime'], 'Y-m-d') == date('Y-m-d')):?>class="cred"<?php endif;?>><?php echo pe_date($v['pointlog_atime']) ?></span></td>
			...
			<td><?php echo $v['pointlog_text'] ?></td>
		</tr>
		<?php endforeach;?>
		</table>
		</form>
