...
<div class="right">
	<div class="now">
		<a href="admin.php?mod=admin" class="sel"><?php echo $menutitle ?>（<?php echo $tongji['all'] ?>）</a>
	...
	<div class="right_main">
		...
		<tr>
			...
			<td>
				<a href="admin.php?mod=admin&act=edit&id=<?php echo $v['admin_id'] ?>" class="admin_edit mar3">修改</a>
				<a href="admin.php?mod=admin&act=del&id=<?php echo $v['admin_id'] ?>&token=<?php echo $pe_token ?>" class="admin_del" onclick="return pe_cfone(this, '删除')">删除</a>
			</td>
		</tr>
		<?php endforeach;?>
		</table>
