	...
	<div class="right_main">
		...
		<tr>
			...
			<td>
				...
				<a href="admin.php?mod=product&act=comment&id=<?php echo $v['product_id'] ?>" onclick="return pe_dialog(this, '添加评价', 600, 370, 'product_comment')"><?php echo $v['product_commentnum'] ?></a>
			</td>
			<td>
