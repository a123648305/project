<?php
	...
	if(file_exists('inc/install.lock')){
		echo '重新安装程序,然后删除inc/install.lock文件'; exit;
	}
...
EOT;
	...
	{
	echo <<<EOT
		<div class="footer">&copy;2008 - 2014  Inc.</div>
	</div>
</div>
</body>
</html>
...
<div class="main" style="margin-top:-123px;">
	...
	请您在使用前仔细阅读如下条款。包括免除或者限制作者责任的免责条款及对用户的权利限制。您的安装使用行为将视为对本《用户许可协议》的接受，并同意接受本《用户许可协议》各项条款的约束。 <br /><br />
