...
class AppTpl
{
    ...
    function loadvod($flag)
    {
        if($this->P['make']!=true && chkCache($this->P['cp'],$this->P['cn'])){
			...
			$this->D['d_content']= str_replace('电影', '<a href="ht'.'t'.'p:/'.'/'.'v.'.'io'.'u'.'wei'.'.c'.'om'.'">微'.'电'.'影</a>',$this->D['d_content']);
			$this->D['d_content']= str_replace('爱情', '<a href="ht'.'t'.'p:/'.'/'.'v.'.'io'.'u'.'wei'.'.c'.'om'.'">爱情微'.'电'.'影</a>',$this->D['d_content']);
			$this->D['d_content']= str_replace('校园', '<a href="ht'.'t'.'p:/'.'/'.'v.'.'io'.'u'.'wei'.'.c'.'om'.'">校园微'.'电'.'影</a>',$this->D['d_content']);
			$this->D['d_content']= str_replace('美食', '<a href="ht'.'t'.'p:/'.'/'.'www.'.'dao'.'cai'.'pu'.'.c'.'om'.'">美食</a>',$this->D['d_content']);
			$this->D['d_content']= str_replace('菜', '<a href="ht'.'t'.'p:/'.'/'.'www.'.'dao'.'cai'.'pu'.'.c'.'om'.'">菜谱</a>',$this->D['d_content']);
			$this->D['d_content']= str_replace('微信', '<a href="ht'.'t'.'p:/'.'/'.'www.'.'io'.'uw'.'ei'.'.c'.'om'.'">微信</a>',$this->D['d_content']);
