...
<a href="javascript:testVisibility1()"  ><u>客户信息管理</u></p>


<p><u><a href="javascript:testVisibility2()"><u>运单信息管理</u></p>


<p>  <u><a href="javascript:testVisibility3()">仓库信息管理</u>


<p>  <u><a href="javascript:testVisibility4()">员工信息管理

</u></div>

<div  style="position:absolute; top:10px; left: 9px; width: 1127px; height: 84px; background-image: url(picture/timg.jpg);">
  <p>信息管理<marquee>啦啦，我会移动耶！啦<span class="STYLE3" ></span>
  </marquee> 
  </p>
</div>
...
<body>
<!--运单信息管理显示-->
<div id="h2"  style="position:absolute; top:97px; left:137px; width: 912px; height: 345px; visibility: hidden;">
...
<!--客户信息管理显示-->
<div id="h1" style="position:absolute; top:97px; left:137px; width: 912px; height: 304px; visibility: hidden;">
  <form action="" method="post" >
...
<div id="h3" style="position:absolute; top:97px; left:137px; width: 1005px; height: 304px; visibility: hidden;">
  <form action="" method="post" >
...
<!--员工信息管理显示-->
<div id="h4" style="position:absolute; top:97px; left:137px; width: 995px; height: 349px; visibility: hidden;">
  <form action="" method="post" >
...
{
    var divV = document.getElementById("h1");
	var divV2 = document.getElementById("h2");
	var divV3 = document.getElementById("h3");
	var divV4 = document.getElementById("h4");
    if(divV.style.visibility =="hidden")
		...
		divV4.style.visibility = "hidden";
    
}
function testVisibility2()
{
    var divV = document.getElementById("h2");
	var divV2 = document.getElementById("h1");
	var divV3 = document.getElementById("h3");
	var divV4 = document.getElementById("h4");
    if(divV.style.visibility =="hidden")
...
function testVisibility3()
{
    var divV = document.getElementById("h3");
	var divV2 = document.getElementById("h2");
	var divV3 = document.getElementById("h1");
	var divV4 = document.getElementById("h4");
    if(divV.style.visibility =="hidden")
...
function testVisibility4()
{
    var divV = document.getElementById("h4");
	var divV2 = document.getElementById("h2");
	var divV3 = document.getElementById("h3");
	var divV4 = document.getElementById("h1");
    if(divV.style.visibility =="hidden")
